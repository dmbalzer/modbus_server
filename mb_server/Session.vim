...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 90 - ((5 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 90
...
badd +1 src/lua_mb.h
badd +1 src/lua_mb.c
badd +2 scripts/script.lua
badd +1 scripts/config.lua
badd +33 src/lua_mb_bits.c
